COMMENT
   ...
   **************************************************
   ...
   KC_nmodl_tabfix (Type: Channel mechanism, Model: File Based Membrane Mechanism)

   with parameters: 
   Max Conductance Density = 8.0E-7 mS um^-2 
...
PARAMETER {
	...
	v		(mV)
	cai		(mM)
    gmax=0.08    (mho/cm2)   : Maximum Permeability
	ek  = -85	(mV)
	dt		(ms)
}
